...
namespace TImesheet_demo2.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(Timesheet_Demo2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'Timesheet_Demo2Context.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Timesheet_Demo2Context.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
